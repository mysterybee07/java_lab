...
public class MenuBarWithIcons {
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Menu Bar with Icons");
        ...
        JMenuItem openMenuItem = new JMenuItem("Open", createIcon("src/Lab29/open.png"));
        JMenuItem saveMenuItem = new JMenuItem("Save", createIcon("src/Lab29/save.png"));
        JMenuItem exitMenuItem = new JMenuItem("Exit", createIcon("src/Lab29/exit.png"));
