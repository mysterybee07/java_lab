...
import java.awt.*;
public class InternalFrameAndTable {
    public static void main(String[] args) {
        // Create the main JFrame container
        JFrame frame = new JFrame("Internal Frame And Table");
        ...
        JInternalFrame internalFrame = new JInternalFrame("Grades", true, true, true, true);
